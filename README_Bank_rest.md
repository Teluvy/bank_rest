...
Коллекция тестовых запросов находится в файле postman_collection.json (или примеры в разделе документации). Основные сценарии:
    ...
    Негативные сценарии (недостаток средств, чужая карта и т.д.)
